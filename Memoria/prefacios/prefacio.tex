...
%\vspace{0.7cm}
\noindent{\textbf{Palabras clave}: trading algorítmico, trading automático, \textit{Wyckoff}, mercados financieros}\\
...
%\vspace{0.7cm}
\noindent{\textbf{Keywords}: algorithmic trading, automic trading, \textit{Wyckoff}, financial markets}\\
